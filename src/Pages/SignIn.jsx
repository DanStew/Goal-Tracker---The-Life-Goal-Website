...
import {validateInputs, validateResetEmail} from "../Functions/validateInputs";
        ...
        <div className={"Login PageBody flexSetup column flexItems"}>
            ...
            <div className="mainBody formBackground flexItems">
                ...
                <div className="flexSetup noGap">
                    ...
                    <button className="changePassword" onClick={() => setWindowShown(!windowShown)}>Change Password</button>
                </div>
                {windowShown? 
                    <div className="flexSetup column smallGap flexItems">
                        ...
                        <form action="#">
                            <div className="flexSetup noGap flexItems">
                                <input type="email" value={resetEmail} placeholder="Email Address..." onChange={(e) => setResetEmail(e.target.value)} />
                                <button type="button" onClick={() => processResetEmail()}className="changePassword flexItems">Change Password</button>
                                <button type="button" onClick={() => setWindowShown(!windowShown)} className="flexItems">Close</button>
                            </div>
                        </form>
                        {resetErrorMsg != "" ? <span className="transfer error">{resetErrorMsg}</span> : <span></span>}
                    </div> 
