    ...
    <div className={mainClass}>
      ...
      <div className="main flexItems">
        <div className="header flexItems">
          ...
          <p className={colourScheme}>Settings</p>
        ...
        <div className="content flexItems">
          ...
          <SettingsComp currentUser={currentUser} changedColourScheme={changedColourScheme} setChangedColourScheme={(e) => setChangedColourScheme(e)} colourScheme={colourScheme}/>
        </div>
      </div>
